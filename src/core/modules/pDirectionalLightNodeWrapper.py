...
class DirectionalLightNodeWrapper( BaseWrapper ):
  wrapperTypeTag = 'DirectionalLightNodeWrapper'
  
  def onCreateInstance( self, parent ):
    # this is called when the user presses the button to create
    # a nodePathWrapper
    node = DirectionalLightNodeWrapper( parent )
  ...
  def loadFromEggGroup( self, eggGroup, parent ):
    ...
    objectInstance = DirectionalLightNodeWrapper( parent )
